...
public class MainActivity extends AppCompatActivity {
    ...
    private static final String s1 = "results";
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        if(savedInstanceState != null) {
           String queryUrl = savedInstanceState.getString(S);
           String raw = savedInstanceState.getString(s1);
            mUrlDisplayTextView.setText(queryUrl);
            mSearchResultsTextView.setText(raw);
        }
    }
    ...
    protected void onSaveInstanceState(Bundle outstate) {
        ...
        outstate.putString(S,queryurl);
        String raw = mSearchResultsTextView.getText().toString();
        outstate.putString(s1,raw);
    }
